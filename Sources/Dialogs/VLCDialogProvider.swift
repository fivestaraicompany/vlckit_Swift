...
// MARK: - Question type
extension VLCDialogQuestionType {
     static let normal: VLCDialogQuestionType = VLCDialogQuestionType(rawValue: libvlc_dialog_question_normal)
     static let warning: VLCDialogQuestionType = VLCDialogQuestionType(rawValue: libvlc_dialog_question_warning)
     static let critical: VLCDialogQuestionType = VLCDialogQuestionType(rawValue: libvlc_dialog_question_critical)
}

// MARK: - Dialog provider
public extension VLCDialogProvider {
    ...
    private var _customRenderer: VLCCustomDialogRendererProtocol?
         ...
         @objc convenience init(library: VLCLibrary?, customUI: Bool) {
            ...
            self.init(library: lib, customUI: customUI)
        }
