...
@objc public final class VLCFilterParameter: NSObject {
        @objc public var value: AnyObject {
          get { properties[kVLCFilterParameterPropertyPropertyValueKey] as! AnyObject }
          set {
        ...
        @objc public static func create(withProperties properties: [String: AnyObject]) -> VLCFilterParameter {
          VLCFilterParameter(properties: properties)
           }
    
        @objc public required init(properties: [String: AnyObject]) {
        ...
        @objc public var enabled: Bool {
          ...
          set {
              guard newValue != _enabled else { return }
               _enabled = newValue
              libvlc_video_set_adjust_int(_mediaPlayer, libvlc_adjust_Enable, newValue ? 1 : 0)
               }
           }
