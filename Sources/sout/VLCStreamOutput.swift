...
public extension VLCStreamOutput {
      static var defaultRTSP: String { VLCDefaultStreamOutputRTSP }
      static var defaultRTP: String { VLCDefaultStreamOutputRTP }
    
      static func rtpBroadcast(withSAPAnnounce announceName: String) -> VLCStreamOutput {
          return VLCStreamOutput(optionDictionary: [
              "rtpOptions": [
      ...
      static func rtpBroadcast() -> VLCStreamOutput {
          return rtpBroadcast(withSAPAnnounce: "Helloworld!")
      }
...
public extension VLCStreamOutput {
       func representedLibVLCOptions() -> String {
          ...
          if let outputOpts = opts["outputOptions"] as? [String: String] {
              ...
              if let d = outputOpts["destination"] { subOpts.append("dst=\"\(d.replacingOccurrences(of: "\"", with: "\\\""))\"") }
              if let u = outputOpts["url"] { subOpts.append("url=\"\(u.replacingOccurrences(of: "\"", with: "\\\\}\"")")\"") }
